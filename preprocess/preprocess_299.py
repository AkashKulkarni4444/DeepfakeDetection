...
def saveFaces(img, video_num, frame_num, folder_name):
    ...
    full_path = "picture_299/" + folder_name
...
if __name__ == '__main__':
    ...
    # # print(lastvideo)
    directory = "picture_299/" + type + "/" + folder
    ...
    if (type == "raw"):
        ...
        all_video = sorted(os.listdir("D:/IIIT/IIIT_Shri_City/BTP/dataset/original_sequences/" + folder + "/c23/videos"))
        ...
        for i in range(len(video)):
            if (video_num < int(lastvideo)):
                video_num += 1
                continue
            video_path = "D:/IIIT/IIIT_Shri_City/BTP/dataset/original_sequences/" + folder + "/c23/videos/" + video[i]
            print(video_path)
    ...
    if (type == "fake"):
        ...
        all_video = sorted(os.listdir("D:/IIIT/IIIT_Shri_City/BTP/dataset/manipulated_sequences/" + folder + "/c23/videos"))
        video = [i for i in all_video if is_video(i)]
        video_num = 1
        ...
        for i in range(len(video)):
            if (video_num < int(lastvideo)):
                video_num += 1
                continue
            video_path = "D:/IIIT/IIIT_Shri_City/BTP/dataset/manipulated_sequences/" + folder + "/c23/videos/" + video[i]
            print(video_path)
            # frame_folder = "real_frame"
            extract_frames(video_path, video_num, outputFolder)
            video_num += 1
