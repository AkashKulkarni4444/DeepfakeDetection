...
if __name__ == '__main__':
    ...
    if (type == "raw"):
        ...
        frame_count = []
        video_files2 = glob.glob("D:/IIIT/IIIT_Shri_City/BTP/code/COMP90055_Research_Project-master/preprocess/video_224/"+type+"/"+folder+"/*.mp4")
        video_files3 = list(map(lambda s: s.split('/')[-1], video_files2))
        for video_file in video_files:
            if (video_file.split('/')[-1] in video_files3) :
                continue
            else:
